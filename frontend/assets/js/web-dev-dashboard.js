    ...
    return `
      ...
      <div class="content-section">
        ...
        <ul>
          ...
          <li>Learn practical coding techniques</li>
          <li>Build responsive components</li>
          <li>Master modern web standards</li>
        </ul>
      </div>

      <div class="content-section">
        <h3><i class="ri-key-line"></i> Key Concepts</h3>
        <p><strong>${title}:</strong> This is a fundamental concept in modern web development. Mastering this will allow you to build more dynamic, efficient, and user-friendly websites.</p>
      </div>

      <div class="content-section">
        <h3><i class="ri-global-line"></i> Industry Impact</h3>
        <p>In today's digital landscape, understanding ${title.toLowerCase()} is essential for creating high-performance web applications that meet user expectations.</p>
      </div>
    `;
  }
  ...
  if (nextBtn) {
    nextBtn.addEventListener('click', () => {
      ...
      if (currentIndex < allLessons.length - 1) {
        ...
        alert('🎉 Congratulations! You\'ve completed the Web Development course!');
      }
    });
  }
