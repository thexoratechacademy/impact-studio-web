    ...
    return `
      ...
      <div class="content-section">
        ...
        <ul>
          ...
          <li>Learn practical data analysis techniques</li>
          <li>Apply knowledge to real-world datasets</li>
      ...
      <div class="content-section">
        ...
        <p><strong>${title}:</strong> This concept is a cornerstone of modern data analysis. Mastering it will allow you to extract deeper insights and make more accurate predictions.</p>
      </div>

      <div class="content-section">
        <h3><i class="ri-global-line"></i> Business Impact</h3>
        <p>Data-driven organizations rely on these techniques to optimize operations and drive strategy. Understanding ${title.toLowerCase()} is essential for any modern analyst.</p>
      </div>
    `;
  }
  ...
  if (nextBtn) {
    nextBtn.addEventListener('click', () => {
      ...
      if (currentIndex < allLessons.length - 1) {
        ...
        alert('🎉 Congratulations! You\'ve completed the Data Analysis course!');
      }
    });
  }
