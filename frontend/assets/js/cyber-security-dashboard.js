    ...
    return `
      ...
      <div class="content-section">
        ...
        <ul>
          ...
          <li>Apply security best practices to this area</li>
          <li>Identify common vulnerabilities and threats</li>
          <li>Learn defense mechanisms and countermeasures</li>
        </ul>
      </div>

      <div class="content-section">
        <h3><i class="ri-key-line"></i> Key Concepts</h3>
        <p><strong>${title}:</strong> This fundamental area of cybersecurity is essential for any security professional. Mastering this topic will significantly improve your ability to protect systems and respond to threats.</p>
      </div>

      <div class="content-section">
        <h3><i class="ri-global-line"></i> Real-World Impact</h3>
        <p>Understanding these concepts is critical in modern security operations. Professionals who master ${title.toLowerCase()} are better equipped to prevent breaches and secure infrastructure.</p>
      </div>
    `;
  }
  ...
  if (nextBtn) {
    nextBtn.addEventListener('click', () => {
      ...
      if (currentIndex < allLessons.length - 1) {
        ...
        alert('🎉 Congratulations! You\'ve completed the Cybersecurity course!');
      }
    });
  }
